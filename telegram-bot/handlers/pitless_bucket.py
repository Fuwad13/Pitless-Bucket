...
btn_business_mode = InlineKeyboardButton(text="Business Mode", callback_data="business_mode")
btn_allow_groups = InlineKeyboardButton(text="Allow Groups?", callback_data="allow_groups")
btn_group_privacy = InlineKeyboardButton(text="Group Privacy", callback_data="group_privacy")
btn_group_admin = InlineKeyboardButton(text="Group Admin Rights", callback_data="group_admin")
btn_channel_admin = InlineKeyboardButton(text="Channel Admin Rights", callback_data="channel_admin")
...
btn_paid_broadcast = InlineKeyboardButton(text="Paid Broadcast", callback_data="paid_broadcast")
...
@pb_router.message(Command("test"))
